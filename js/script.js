...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const OPNFORM_TOKEN = "609|jBLh8VYjNNO84X8fQ8aPUVgvHX9lfbqiez9s2zm4031c6b0a"; 
    const OPNFORM_FORM_ID = "trashless-tech-hardware-donation-form-hfp1dg"; 
    ...
    window.goTo = function (step) {
        console.log('goTo() called with step:', step); // Debug log
